...
iqtree2 -T 64 -st AA -S $training -cmax 4 -mset $model_set -pre 02_fullcon_$training/iteration_1
...
iqtree2 -T 64 -S 02_fullcon_$training/iteration_1.best_scheme.nex -te 02_fullcon_$training/iteration_1.treefile --init-model LG --model-joint GTR20+FO -pre 02_fullcon_$training/iteration_1.GTR20
